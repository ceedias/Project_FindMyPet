...
public class MainActivity extends AppCompatActivity
    ...
    private void changeMail(String email, String nome){
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_sair) {
            ...
            Intent i = new Intent(MainActivity.this, ListaCartaoActivity.class);
            startActivity(i);

        }else if (id == R.id.nav_perdidos) {
            Intent i = new Intent(MainActivity.this, CadastroPerdidosActivity.class);
            startActivity(i);
        }
