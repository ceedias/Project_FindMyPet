...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
        ...
        mPasswordView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
                ...
                if (id == EditorInfo.IME_ACTION_DONE || id == EditorInfo.IME_NULL) {
                    ...
                    if(mEmailView.equals("admin") && mPasswordView.equals("admin")){
                        attemptLogin();
                    }else{
                        return false;
                    }
    ...
    private boolean login(String email, String senha){
        ...
        /*
        final Call<Usuario> callAPI = ServicesAPI.get().login(email,senha);
        ...
        callAPI.enqueue(new Callback<Usuario>() {
            ...
            public void onResponse(Response<Usuario> response,
                ...
                if (response.body() != null){
                    ...
                    i.putExtra("email",response.body().email);
                    i.putExtra("nome",response.body().nome);
                    startActivity(i);
                    finish();
                }else{
